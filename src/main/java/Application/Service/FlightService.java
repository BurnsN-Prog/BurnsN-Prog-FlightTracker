...
public class FlightService {
    ...
    public Flight updateFlight(int flight_id, Flight flight){
        // Check if the flight exists by attempting to retrieve it by ID.
        Flight existingFlight = flightDAO.getFlightById(flight_id);

        if (existingFlight == null) {
        // Return null if no flight exists with the given ID.
        return null;
    }
    flightDAO.updateFlight(flight_id, existingFlight);
        // Update the flight using the DAO method and return the updated flight.
